        ...
        public AdcData[] FFT3 (double freq, string[] chipdata) {
            ...
            for (int isig = 0; isig < 4; isig++) {
                ...
                for (int i = 1; i < (sampLength / 2); i++) {
                    ...
                    if (binCont != 1.0) {            // This is all points except the signal
                        numPoints++;
                ...
                for (int k = 0; k <= 20; k++) {
                    for (int ord = -55; ord <= 55; ord++) {
                        ...
                        if (tempFreq != freq && tempFreq < sampFreq / 2 && tempFreq > 0) {     // Limits range of interesting harmonics
                            numHarm++;
                ...
                fftID.CustomItems[2].Cells.Add(new LegendCell("Chip " + chipNumBox.Text.PadLeft(5,'0')));
                ...
                for (int i = 0; i < 11; i++) fftInfo.CustomItems.Add(new LegendItem());
